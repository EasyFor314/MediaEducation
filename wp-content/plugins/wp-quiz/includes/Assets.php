	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'       => array(
					'correct'               => esc_html__( 'Правильно!', 'wp-quiz' ),
					'wrong'                 => esc_html__( 'Не правильно!', 'wp-quiz' ),
					...
					'emptyNameEmail'        => esc_html__( 'Пожалуйства, введите своё имя и электронную почту!', 'wp-quiz' ),
