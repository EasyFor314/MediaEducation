	...
	<div class="wq_singleQuestionCtr">
		...
		<div class="wq-question-answers wq_questionAnswersCtr">
			...
			if ( $total_corrects > 1 ) {
				...
				echo '<p>' . sprintf( esc_html__( 'Пожалуйста, выберите %d правильный ответ', 'wp-quiz' ), intval( $total_corrects ) ) . '</p>';
			}
			?>
		...
		<div class="wq-trivia-question-explanation wq_triviaQuestionExplanation">
			<div class="wq-explanation-head wq_ExplanationHead">
				<span class="wq-explanation-head-correct"><?php echo esc_html_e( 'Правильно!', 'wp-quiz' ); ?></span>
				<span class="wq-explanation-head-incorrect"><?php echo esc_html_e( 'Не правильно!', 'wp-quiz' ); ?></span>
			</div>
