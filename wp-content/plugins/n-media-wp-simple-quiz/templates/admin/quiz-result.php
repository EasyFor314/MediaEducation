...
?>
    <div class="wqt_wrapper">
        <ul class="list-group display-ul">
            ...
            <li class="list-group-item Design-li"><?php _e('Obtain Marks : ' , 'wqt'); ?>
                <?php echo $obtained_marks; ?>
            </li>
            <li class="list-group-item Design-li"><?php _e('Percentage : ' , 'wqt'); ?>
                <?php echo $percentage; ?>
            </li>
            ...
            <li class="list-group-item Design-li"><?php _e('Total Correct Question : ' , 'wqt'); ?> 
        ...
        <table class="table table-bordered">
            <thead>
                <tr class="table-border-color">
                    <th><?php _e('Question' , 'wqt'); ?></th>
                    <th><?php _e('User Selected Answer' , 'wqt'); ?></th>
                    <th><?php _e('Correct Answers' , 'wqt'); ?></th>
                    <th><?php _e('Marks Obtains' , 'wqt'); ?></th>
