...
/* ===== Frontend quiz form  ====== */
	...
	$wqt_quiz_message   = $quizz_setting->get_option('wqt_quiz_message')!= ''?
					      $quizz_setting->get_option('wqt_quiz_message') :'Ваш тест завершён!';
	...
	<div class="form-body register_form">
		...
		<div class="wqt-form-input">
			<div class="form-group">
				<span><?php _e('Имя пользователя:','wqt') ?></span>
				<input type="name" class="form-control" placeholder="Введите полное имя" name="username" required>
			</div>
			<div class="form-group">
				<span><?php _e('Электронная почта:','wqt') ?></span>
				<input type="email" class="form-control" placeholder="Введите электронную почту" name="email" required>
			</div>
		...
		<div class="sub_btn">
			<input name="commit" style="background: <?php echo $btn_clr?> !important; color:<?php echo $btn_text_clr?>" type="submit" value="Отправить">
